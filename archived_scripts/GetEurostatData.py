...
if(opts.categories[0] == "NATURAL" ):
	...
	i=12
        ...
        categories_list = "FOOD_P+FOOD_NP+IGD_NNRG_D+IGD_NNRG_SD+IGD_NNRG_ND+ELC_GAS+FUEL+SERV_COM+SERV_HOUS+SERV_TRA+SERV_REC+SERV_MSC"
        i=12
else:
